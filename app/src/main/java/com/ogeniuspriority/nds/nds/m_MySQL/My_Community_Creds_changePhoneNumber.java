...
public class My_Community_Creds_changePhoneNumber extends AsyncTask<Void, Void, String> {
    ...
    public My_Community_Creds_changePhoneNumber(Context c, String urlAddress, String MyRemoteId, String theNumber, String theCode, PopupWindow pmI, Activity act) {
        this.c = c;
