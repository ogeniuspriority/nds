...
public class My_Community_Creds_changeLocationInfo extends AsyncTask<Void, Void, String> {
    ...
    public My_Community_Creds_changeLocationInfo(Context c, String urlAddress, String MyRemoteId, String LocationInfo, PopupWindow popupWindow_000, Activity act) {
        this.c = c;
