...
public class Profile_edit extends AppCompatActivity {
    ...
    TextView edit_contact_number;
    TextView login_info;
    TextView edit_login_info;
    TextView locationdata;
    TextView edit_location;
    TextView work_info;
    TextView edit_work_info;
    Button edit_names;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_contact_number = (TextView) findViewById(R.id.edit_contact_number);
        login_info = (TextView) findViewById(R.id.login_info);
        edit_login_info = (TextView) findViewById(R.id.edit_login_info);
        ...
        edit_names = (Button) findViewById(R.id.edit_names);
        //p--------
        ...
        edit_work_info = (TextView) findViewById(R.id.edit_work_info);
    ...
    public void editProfile_login_info(View v) {
        //Log.w("cyuma",""+path);
        LayoutInflater layoutInflater = (LayoutInflater) Profile_edit.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View popupView = layoutInflater.inflate(R.layout.edit_login_info, null);
        ...
        popupWindow_000.setOutsideTouchable(true);
        ...
        final EditText passwordretype = (EditText) popupView.findViewById(R.id.passwordretype);
        ...
        email_sign_in_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (email.getText().toString().isEmpty() || password.getText().toString().isEmpty() || passwordretype.getText().toString().isEmpty()) {
                    ...
                    new My_Community_Creds_changeLoginInfo(Profile_edit.this, Config.NDS_USER_LOGIN_INFO, MYRemoteId, email.getText().toString(), password.getText().toString(), popupWindow_000, Profile_edit.this).execute();
                }
        ...
        popupWindow_000.showAtLocation(v, Gravity.CENTER, Gravity.CENTER_HORIZONTAL, Gravity.CENTER_VERTICAL);
    ...
    public void editProfile_contact_number(View v) {
        //Log.w("cyuma",""+path);
        LayoutInflater layoutInflater = (LayoutInflater) Profile_edit.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View popupView = layoutInflater.inflate(R.layout.edit_contact_number, null);
        //---------
        final PopupWindow popupWindow_000 = new PopupWindow(
                popupView,
                ViewGroup.LayoutParams.FILL_PARENT,
        ...
        //----------------------------------
        final EditText number_field = (EditText) popupView.findViewById(R.id.number_field);
        final EditText thecode = (EditText) popupView.findViewById(R.id.thecode);
        ...
        final TextView progressText = (TextView) popupView.findViewById(R.id.progressText);
        final LinearLayout resend_code_now = (LinearLayout) popupView.findViewById(R.id.resend_code_now);
        final ImageView resend_img = (ImageView) popupView.findViewById(R.id.resend_img);
        final Button conf_change = (Button) popupView.findViewById(R.id.conf_change);
        ...
        Button Continue = (Button) popupView.findViewById(R.id.Continue);
        //----------------------
        Continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!thecode.getText().toString().isEmpty()) {
                    m_handler.removeCallbacks(m_handlerTask);
                    LinearLayout resend_code_now = (LinearLayout) popupView.findViewById(R.id.resend_code_now);
                    resend_code_now.setVisibility(View.VISIBLE);
                    progressText.setText(" ");
                    _count = 0;
                            ...
                            try {
                                ...
                                if (netInfo != null && netInfo.isConnected()) {
                                    try {
                                        ...
                                        if (urlc.getResponseCode() == 200) {        // 200 = "OK" code (http connection is fine).
                                            Log.wtf("Connection", "Success !");
                                            new My_Community_Creds_changePhoneNumber(Profile_edit.this, Config.NDS_USER_CONFIRM_NUMBER, MYRemoteId, "" + number_field.getText().toString(), thecode.getText().toString(), popupWindow_000, Profile_edit.this).execute();
    ...
    public void editProfile_location_info(View v) {
        //Log.w("cyuma",""+path);
        LayoutInflater layoutInflater = (LayoutInflater) Profile_edit.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View popupView = layoutInflater.inflate(R.layout.edit_location_location, null);
        ...
        //--
        final EditText LocationInfo = (EditText) popupView.findViewById(R.id.LocationInfo);
        Button email_sign_in_button = (Button) popupView.findViewById(R.id.email_sign_in_button);
        ...
        email_sign_in_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!LocationInfo.getText().toString().isEmpty()) {
                    new My_Community_Creds_changeLocationInfo(Profile_edit.this, Config.NDS_USER_LOACTION_INFO, MYRemoteId, LocationInfo.getText().toString(), popupWindow_000, Profile_edit.this).execute();
                } else {
                    Toast.makeText(Profile_edit.this, "Empty field!", Toast.LENGTH_SHORT).show();
                }
    ...
    public void editWork_info(View v) {
        //Log.w("cyuma",""+path);
        LayoutInflater layoutInflater = (LayoutInflater) Profile_edit.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View popupView = layoutInflater.inflate(R.layout.edit_location_info, null);
        ...
        //---
        final EditText WorkInfo = (EditText) popupView.findViewById(R.id.WorkInfo);
        Button email_sign_in_button = (Button) popupView.findViewById(R.id.email_sign_in_button);
        ...
        email_sign_in_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!WorkInfo.getText().toString().isEmpty()) {
                    new My_Community_Creds_changeWorkInfo(Profile_edit.this, Config.NDS_USER_WORK_INFO, MYRemoteId, WorkInfo.getText().toString(), popupWindow_000, Profile_edit.this).execute();
                } else {
                    Toast.makeText(Profile_edit.this, "Empty field!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void editNames(View v) {
        //Log.w("cyuma",""+path);
        LayoutInflater layoutInflater = (LayoutInflater) Profile_edit.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View popupView = layoutInflater.inflate(R.layout.edit_names, null);
        ...
        //--
        final EditText Names = (EditText) popupView.findViewById(R.id.Names);
        ...
        email_sign_in_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!Names.getText().toString().isEmpty()) {
                    new My_Community_Creds_changeNames(Profile_edit.this, Config.NDS_USER_NAMES, MYRemoteId, Names.getText().toString(), popupWindow_000, Profile_edit.this).execute();
                } else {
                    Toast.makeText(Profile_edit.this, "Empty field!", Toast.LENGTH_SHORT).show();
                }
